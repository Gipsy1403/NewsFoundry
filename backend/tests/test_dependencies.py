...
# vérifie que l'identifiant de l'utilisateur est correctement extrait du token JWT
...
# vérifie que l'exception HTTP est levée lorsque le token JWT est invalide
